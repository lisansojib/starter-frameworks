...
using Presentation.Extends.Results;
...
namespace Presentation.Controllers
{
    ...
    public class AccountApiController : ApiBaseController
    {
        ...
        private readonly IUserDTORepository _repository;
        private readonly IAuthenticationManager _authenticationManager;

        public AccountApiController(IUserDTORepository repository, ApplicationUserManager userManager, IAuthenticationManager authenticationManager)
        {
        ...
        public async Task<IHttpActionResult> GetExternalLogin(string provider, string error = null)
        {
            ...
            LoginUser user = await _userManager.FindAsync(new UserLoginInfo(externalLogin.LoginProvider,
