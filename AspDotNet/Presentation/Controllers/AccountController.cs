...
namespace Presentation.Controllers
{
    public class AccountController : BaseController
    {
...
#if DEBUG
            ViewBag.UserName = "EPYMis";
            ViewBag.Password = "MisEPYAcs*6";
#else
            ViewBag.UserName = "";
            ViewBag.Password = "";
#endif
        ...
        public async Task<ActionResult> VerifyCode(string provider, string returnUrl, bool rememberMe)
        {
            ...
            return View(new VerifyCodeBindingModel { Provider = provider, ReturnUrl = returnUrl, RememberMe = rememberMe });
        }
        ...
        public ActionResult ExternalLogin(string provider, string returnUrl)
        {
            ...
            return new MvcChallengeResult(provider, Url.Action("ExternalLoginCallback", "Account", new { ReturnUrl = returnUrl }));
        }
